...
public class RecyclerTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    //to enable edit and delete options in the recycler list in Strengths(Main Activity) Activity
    ...
    // the animation for swiping action -- referenced from https://www.youtube.com/watch?v=hnuMyuCWwwU [www.youtube.com. (n.d.). Swipe Items in RecyclerView ]
    @Override
